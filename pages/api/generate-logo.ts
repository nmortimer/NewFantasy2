...
const NAMED_HEX: Record<string, string> = {
  '#E31837': 'scarlet', '#FFB612': 'athletic gold', '#203731': 'green', '#0B162A': 'deep navy',
  '#C83803': 'orange', '#0A2342': 'navy blue', '#FB4F14': 'bronco orange', '#002244': 'navy',
  '#69BE28': 'action green', '#4F2683': 'purple', '#FFC62F': 'gold', '#008E97': 'teal',
  '#FC4C02': 'orange-red', '#AA0000': 'red', '#B3995D': 'gold metallic', '#A5ACAF': 'silver',
  '#041E42': 'cowboys blue', '#869397': 'silver gray', '#0B2265': 'giants blue', '#A71930': 'crimson',
  '#00338D': 'royal blue', '#C60C30': 'red', '#125740': 'forest green', '#241773': 'purple',
  '#000000': 'black', '#0085CA': 'panthers blue', '#101820': 'black', '#006778': 'teal',
  '#9F792C': 'bronze', '#D3BC8D': 'vegas gold', '#0073CF': 'charger blue', '#FFC20E': 'bolt gold',
};
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const styleIdx = (typeof team.style === 'number' && team.style >= 0 && team.style < STYLE_VARIANTS.length)
      ? team.style : variationSeed % STYLE_VARIANTS.length;
    ...
    const subjectLine =
      `Subject phrase: “${subject}”. Interpret this phrase semantically and depict a SINGLE mascot/object that represents it (e.g., “Swedish Arctic Foxes” → an arctic fox head). Do NOT draw any words.`;
    ...
    const prompt =
      ...
      `${paletteBlock}. ${negatives}. Palette reminder: ${paletteBlock}.`;
